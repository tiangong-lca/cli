...
Process annual-volume policy follows Issue #283: preserve unknown evidence, reject the exact historical sentinel, and never replace it with a functional-unit amount. The shared Process validator reports schema, authoring and content checks with the complete candidate hash. Authoring holds remain save blockers; schema success alone supplies no metadata-only save, weight or publication admission.
