...
lastReviewedNote: 'Reviewed for CLI #283 at head d45ffb6: the guarded before-image transport and contract dry-run add no dependency, version, credential, provenance or publication step.'
related:
  - ../AGENTS.md
  - ../.docpact/config.yaml
  - ./release-runbook.md
